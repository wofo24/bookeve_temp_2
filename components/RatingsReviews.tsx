...
import { FreeMode, Autoplay, TouchEvents } from 'swiper/modules';
import Image from 'next/image';

// Star SVG component for reuse
const StarIcon = ({ filled = true }) => (
    <svg
        className={`w-[10px] h-[10px] ${filled ? 'text-yellow-400 fill-current' : 'text-gray-300'}`}
        viewBox="0 0 24 24"
    >
    ...
    return (
        <div className="p-4 bg-white shadow-sm">
            ...
            <div className="flex justify-between items-center mb-4">
                <span className="text-[18px] font-[600] text-[rgba(34,37,51,1)]">Ratings & reviews</span>
                <button onClick={() => setRatingsDrawerOpen(true)} className="text-purple-600 text-[12px] font-medium">VIEW ALL</button>
            </div>
            ...
            <div className="flex justify-center items-center mb-6 relative">
                ...
                <div className="text-center m-0">
                    <span className="text-[56px] font-[800] text-[rgba(34,37,51,1)] block leading-[1]">{average}</span>
            ...
            <div className="flex flex-row gap-4 mb-6">
                ...
                <div className="w-[106px] shrink-0">
                    <span className="text-[10px] font-[600] text-[rgba(102,106,123,1)]">Overall Rating</span>
                    ...
                    >
                        {tags.map((tag) => (
                            <SwiperSlide key={tag.id} className="!w-auto" >
                                <div className={`border border-[rgba(222,222,231,1)] rounded-md p-[12px] w-[90px] h-[94px] flex flex-col gap-[10px] hover:shadow-md transition-shadow`}>
                                    <div className="text-lg mb-0.5 w-[28px] h-[28px]">{tag.icon}</div>
            ...
            <div className="relative overflow-hidden mt-6">
                <h2 className="text-sm font-semibold text-gray-800 mb-2">Based on latest reviews</h2>
                            ...
                            <div className="relative w-full rounded-xl overflow-hidden shadow-md bg-white">
                                ...
                                <div className="absolute inset-0 bg-gradient-to-r from-black/60 to-transparent flex items-center px-2">
                                    <div className="text-white">
                                        <p className="text-sm font-semibold leading-[100%] px-4">{offer.title}</p>
                                        <p className="text-sm font-semibold mb-2 px-4">{offer.subtitle}</p>
