  ...
  return (
    <div>
      ...
      <div className='flex flex-col justify-center items-center bg-gray-100'>
        <div className='relative  max-w-sm bg-white overflow-visible'>
          <div className='relative overflow-visible h-[220px] rounded-b-3xl'>
            {/* Background image */}
            <div className="absolute inset-0 w-full h-full bg-[url('/bg.png')] bg-cover bg-center z-0" />
            {/* Header content */}
          ...
          {/* Profile Image */}
          <div className='relative flex flex-row justify-between items-center -mt-16 px-6'>
            <Image
              src={profilePicture}
              alt='Profile Picture'
              className='border-white border-[2px]'
              width={120}
              height={120}
              objectFit='cover'
          ...
          <div className='mt-2 px-6'>
            <SearchInput
              ...
              className='border border-[rgba(222,222,231,1)] text-[16px] font-[400] text-[rgba(90,90,90,1)] focus:outline-none focus:ring-2 focus:ring-blue-400 bg-white'
            />
          </div>

          <div className='flex items-center justify-items-start my-4 px-6'>
            <h2 className='text-[rgba(102,106,123,1)] text-[12px] font-semibold  mr-2'>
              OFFERINGS FOR YOU
            </h2>
        ...
        <div className='w-full max-w-sm px-0 mb-52'>
          <Tabs defaultValue='all'>
            <TabsList className='flex justify-between gap-[12px] bg-white px-6'>
              <TabsTrigger
                value='all'
                className='px-5 font-[400] text-[12px] border border-[rgba(222,222,231,1)] rounded-full bg-white text-gray-700 flex items-center gap-[4px]'
              >
                All
              </TabsTrigger>
              <TabsTrigger
              ...
              <Collapsible defaultOpen className='mb-2'>
                <CollapsibleTrigger className='w-full bg-white'>
                  <div className='m-0 flex flex-row justify-between w-full items-center hover:bg-accent transition-all duration-200 cursor-pointer p-6'>
                    ...
                    <ChevronDown
                      className={`w-5 h-5 transform transition-transform duration-200 text-purple-600 `}
                    />
                  </div>
                </CollapsibleTrigger>
                    ...
                    >
                      <div className='flex justify-between items-center'>
                        <div className='flex-1'>
                          ...
                          <p className='text-[#007A66] text-[12px] font-[300] mb-2 bg-[#E5F5F3] px-1.5 rounded-lg w-max'>
                        ...
                        <div className='flex flex-col items-center'>
                          ...
                          />
                          <button
                            className='bg-white text-purple-600 border border-[rgba(123,60,229,1)] rounded-md px-4 py-1 text-[12px] font-[700]  cursor-pointer mt-0.5'
            ...
            <div className='flex border border-[rgba(222,222,231,1)] rounded-[10px] p-[12px] justify-between items-center text-[rgba(34,37,51,1)] w-full mt-2'>
              <div className='flex gap-[16px]'>
                ...
                <div className='flex flex-col gap-[2px]'>
                  <span className='text-[16px] font-[6  00]'>
                    payal.makeuparist
                  </span>
          ...
          <div className='flex items-center justify-between px-6 bg-white pt-4'>
            <h2 className='text-[rgba(102,106,123,1)] text-[12px] font-[500] uppercase'>
              Know More
            </h2>
          ...
          <Collapsible className='border-dashed border-b border-[rgba(222,222,231,1)]'>
            ...
            <CollapsibleContent className='px-6 bg-white'>
              <div className='pb-6'>Booking Policy content</div>
            </CollapsibleContent>
          </Collapsible>
          <Collapsible className='border-dashed border-b border-[rgba(222,222,231,1)]'>
            <CollapsibleTrigger className='w-full bg-white'>
            ...
            <CollapsibleContent className='px-6 bg-white'>
              <div className='pb-6'>Cancellation Policy content</div>
            </CollapsibleContent>
          </Collapsible>
              ...
              <div className='space-y-3'>
                ...
                <div className='border rounded-lg p-2 flex items-center justify-between'>
                  <div className='flex flex-col'>
                    ...
                    <div className='flex text-[12px] font-[300] text-gray-500 pl-2 gap-2'>
                      <MapPin width={16} height={16} /> 9 Myrtle Lane Richmond
                      Town, Bengaluru, KA
                    </div>
                  </div>
                  <ArrowRight width={20} height={20} />
          ...
          {ratingsDrawer && (
            <BottomDrawer
              isOpen={ratingsDrawer}
              onClose={() => setRatingsDrawerOpen(false)}
              step={1}
            >
              <div className=''>
                {/* title */}
                ...
                <div className='flex justify-center items-center mb-6 relative gap-6'>
                  ...
                  <div className='text-center m-0'>
                    <span className='text-[42px] font-[800] text-[rgba(34,37,51,1)] block leading-[1]'>
                      {average}
                    </span>
              ...
              <div className='flex flex-col items-start gap-3 bg-white'>
                <div className='flex flex-col items-start py-0 pb-2 w-full'>
                  <div className='flex flex-col items-start gap-2 w-full'>
                    <div className='flex flex-row justify-between items-center'>
                      <h2 className='w-72 font-bold text-lg leading-tight text-gray-900'>
                        HD Radiant Bride Makeup Package
                      </h2>
                  ...
                  <div className='flex flex-col justify-center items-start p-3 gap-3 w-full bg-white border border-gray-200 rounded-lg relative'>
                    ...
                    <div className='flex justify-center items-center p-1 px-2 w-full bg-green-50 rounded-md'>
                      <span className='text-xs font-medium text-green-800 text-center'>
                        Advance payment required - $10.00
                      </span>
                    </div>
                ...
                <div className='flex flex-col items-start w-full h-full bg-white'>
                  <div className='flex flex-col items-start p-3 gap-3 w-full h-full bg-purple-50 relative'>
                    ...
                    <h2 className='w-full h-5 font-bold text-base text-gray-900'>
                      Package Details
                    </h2>
                    ...
                    <div className='flex flex-row justify-center items-center p-3 px-4 w-full bg-white rounded-xl'>
                      <p className='w-full h-22 font-light text-sm leading-snug text-gray-900'>
                        This is a comprehensive package that includes all the
                        services you need. Our professional staff will ensure
                    ...
                    <div className='flex flex-col justify-center items-center p-4 gap-4 w-full bg-white rounded-xl'>
                      <div className='flex flex-row items-center w-full h-6'>
                        <h3 className='w-full h-6 font-bold text-xl text-gray-900'>
                          Products Used
                        </h3>
                      </div>
                      ...
                      <div className='flex flex-row items-start gap-3 w-full overflow-x-scroll'>
                        <div className='flex flex-col items-center p-3 gap-2 w-28 h-32 bg-white border border-gray-200 rounded-xl flex-shrink-0'>
                          ...
                          <p className='w-full h-4 font-bold text-xs leading-tight text-center text-gray-900'>
                            Product 1
                          </p>
                        </div>
                        ...
                        <div className='flex flex-col items-center p-3 gap-2 w-28 h-32 bg-white border border-gray-200 rounded-xl flex-shrink-0'>
                          <div className='w-16 h-16 bg-gray-200 rounded'></div>
                          <p className='w-full h-8 font-bold text-xs leading-tight text-center text-gray-900'>
                            Product 3 With Longer Name
                          </p>
                        </div>
                      ...
                      <div className='flex flex-col items-center w-full gap-4 relative'>
                        ...
                        <div className='flex flex-row items-start gap-3 w-full'>
                          ...
                          <p className='w-full text-base font-light leading-6 text-gray-900'>
                            The stylist will consult with you to understand your
                            preferences.
                          </p>
                        </div>
                        ...
                        <div className='flex flex-row items-start gap-3 w-full'>
                          ...
                          <p className='w-full text-base font-light leading-6 text-gray-900'>
                            The main service will be performed by our
                            professional staff.
                          </p>
                        </div>
                    ...
                    <div className='flex flex-col justify-center items-center p-4 gap-4 w-full bg-white rounded-xl'>
                      ...
                      <div className='flex flex-col items-center w-full gap-4'>
                        ...
                        <div className='flex flex-row items-start gap-3 w-full'>
                          ...
                          <p className='w-full text-base font-light leading-6 text-gray-900'>
                            Please ensure pets are kept in a separate area
                            during the service.
                          </p>
                        </div>
                      </div>
                ...
                <div className='flex flex-col items-start gap-4 w-full h-56 bg-white'>
                  <div className='flex flex-col items-start p-3 gap-3 w-full h-46 bg-purple-50 rounded-xl relative'>
                    ...
                    <h2 className='w-full h-5 font-bold text-base text-gray-900 z-10'>
                      Maintenance
                    </h2>
